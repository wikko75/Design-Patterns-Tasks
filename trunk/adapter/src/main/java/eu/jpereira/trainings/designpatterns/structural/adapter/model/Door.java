...
public interface Door {
	 ...
	 */
	void open(String code) throws IncorrectDoorCodeException, CannotUnlockDoorException, CannotChangeStateOfLockedDoor;
	...
	void changeCode(String oldCode, String newCode, String newCodeConfirmation)
			throws IncorrectDoorCodeException, CodeMismatchException, CannotChangeCodeForUnlockedDoor, CannotUnlockDoorException;
	 ...
	 */
	boolean testCode(String code) throws CannotUnlockDoorException;
