...
public interface DoorController {
	 ...
	 */
	void openDoor(Door door, String doorCode) throws DoorNotManagedException, IncorrectDoorCodeException, CannotUnlockDoorException, CannotChangeStateOfLockedDoor;
	
	void closeDoor(Door door) throws DoorNotManagedException, CannotChangeStateOfLockedDoor;
