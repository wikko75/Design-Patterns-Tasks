...
public class SimpleDoorController implements DoorController {
	 ...
	 */
	@Override
	public void openDoor(Door door, String doorCode) throws DoorNotManagedException, IncorrectDoorCodeException, CannotUnlockDoorException, CannotChangeStateOfLockedDoor {
	 ...
	 */
	@Override
	public void closeDoor(Door door) throws DoorNotManagedException, CannotChangeStateOfLockedDoor {
		getDoor(door).close();
