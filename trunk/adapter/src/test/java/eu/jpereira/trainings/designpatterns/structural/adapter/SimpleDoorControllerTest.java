...
public class SimpleDoorControllerTest {
	...
	public void testShouldThrowExceptionForInexistentDoor() throws DoorNotManagedException, IncorrectDoorCodeException, CannotUnlockDoorException, CannotChangeStateOfLockedDoor {
	...
	@Test
	public void testShouldOpenDoor() throws DoorNotManagedException, IncorrectDoorCodeException, CannotUnlockDoorException, CannotChangeStateOfLockedDoor {
		// Create a simple dummy door, conforming the Interface Door
	...
	@Test
	public void testShouldCloseDoor() throws DoorNotManagedException, IncorrectDoorCodeException, CannotUnlockDoorException, CannotChangeStateOfLockedDoor {
		Door mockedDoor = createMockedDoor();
		DoorController controller = createDoorControllerUnderTest();
	...
	@Test(expected = DoorNotManagedException.class)
	public void testShouldThrowExceptionClosingNotManagedDoor() throws DoorNotManagedException, IncorrectDoorCodeException, CannotChangeStateOfLockedDoor {
		Door mockedDoor = createMockedDoor();
		DoorController controller = createDoorControllerUnderTest();
