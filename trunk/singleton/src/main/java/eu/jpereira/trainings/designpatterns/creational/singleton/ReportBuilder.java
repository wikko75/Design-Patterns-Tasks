...
public class ReportBuilder {
	...
	// Class variables
	// Single instance
	private static volatile ReportBuilder instance = null;    // volatile, bo chcemy, by zmiana (inicjalizacja instance) byla widoczna w pozostalych
	...
	public static ReportBuilder getInstance() {
		...
		if (instance == null) {
			synchronized (ReportBuilder.class) {   // ReportBuilder -> moditor object dlatego w arg synchronized
				if (instance == null) {
